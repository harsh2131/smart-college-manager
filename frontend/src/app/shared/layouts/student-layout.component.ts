...
@Component({
    ...
    <div class="layout">
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          <a routerLink="/student/dashboard" routerLinkActive="active" class="nav-item">📊 Dashboard</a>
          <a routerLink="/student/assignments" routerLinkActive="active" class="nav-item">📄 Assignments</a>
          <a routerLink="/student/fees" routerLinkActive="active" class="nav-item">💰 Fees</a>
          <a routerLink="/student/results" routerLinkActive="active" class="nav-item">📝 Results</a>
          <a routerLink="/student/hallticket" routerLinkActive="active" class="nav-item">🎫 Hall Ticket</a>
          <a routerLink="/student/analytics" routerLinkActive="active" class="nav-item">📈 Analytics</a>
        </nav>
        <div class="sidebar-footer">
          <div class="user-info">
            <span>{{ user?.name }}</span>
            <small>{{ user?.stream }} - Sem {{ user?.semester }}</small>
          </div>
  ...
  styles: [`
    ...
    .sidebar { width: 240px; background: #047857; color: white; position: fixed; height: 100vh; display: flex; flex-direction: column; z-index: 100; }
    ...
    .nav-item:hover, .nav-item.active { background: rgba(255,255,255,0.08); color: white; border-left-color: white; }
